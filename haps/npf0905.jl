...
# df = CSV.read("../level3dataall/hou120ncsuhtdmainvertedM1.b1.20220831.csv", DataFrame; header=false)
...
function get_mode(myDd)
    ...
    modek = map(g -> gf2kappa(g, 77.8, myDd .* 1e9), modegf)
...
# event 1 k----
event1ii50 = (tgf50 .>= DateTime(2022,9,5,13,15,0)) .& (tgf50.<= DateTime(2022,9,5,15,33,0) )
event1ii40 = (tgf40 .>= DateTime(2022,9,5,13,15,0)) .& (tgf40.<= DateTime(2022,9,5,15,33,0) )
event1ii30 = (tgf30 .>= DateTime(2022,9,5,13,15,0)) .& (tgf30.<= DateTime(2022,9,5,15,33,0) )
event1ii20 = (tgf20 .>= DateTime(2022,9,5,13,15,0)) .& (tgf20.<= DateTime(2022,9,5,15,33,0) )
...
# event 1 prior k----
pevent1ii50 = (tgf50 .> DateTime(2022,9,5,11,15,0)) .& (tgf50.< DateTime(2022,9,5,13,15,0) )
pevent1ii40 = (tgf40 .> DateTime(2022,9,5,11,15,0)) .& (tgf40.< DateTime(2022,9,5,13,15,0) )
pevent1ii30 = (tgf30 .> DateTime(2022,9,5,11,15,0)) .& (tgf30.< DateTime(2022,9,5,13,15,0) )
pevent1ii20 = (tgf20 .> DateTime(2022,9,5,11,15,0)) .& (tgf20.< DateTime(2022,9,5,13,15,0) )
...
grt = DateTime(2022,9,5,13,15,0):Minute(1):DateTime(2022,9,5,15,33,0) |> collect
