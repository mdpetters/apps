...
function get_mode(myDd)
    ...
    modek = map(g -> gf2kappa(g, 67.2, myDd .* 1e9), modegf)
...
# event 1 k----
event1ii50 = (tgf50 .>= DateTime(2022,7,25,09,35,0)) .& (tgf50.<= DateTime(2022,7,25,12,30,0) )
event1ii40 = (tgf40 .>= DateTime(2022,7,25,09,35,0)) .& (tgf40.<= DateTime(2022,7,25,12,30,0) )
event1ii30 = (tgf30 .>= DateTime(2022,7,25,09,35,0)) .& (tgf30.<= DateTime(2022,7,25,12,30,0) )
event1ii20 = (tgf20 .>= DateTime(2022,7,25,09,35,0)) .& (tgf20.<= DateTime(2022,7,25,12,30,0) )
...
# event 1 prior k----
pevent1ii50 = (tgf50 .> DateTime(2022,7,25,07,35,0)) .& (tgf50.< DateTime(2022,7,25,09,35,0) )
pevent1ii40 = (tgf40 .> DateTime(2022,7,25,07,35,0)) .& (tgf40.< DateTime(2022,7,25,09,35,0) )
pevent1ii30 = (tgf30 .> DateTime(2022,7,25,07,35,0)) .& (tgf30.< DateTime(2022,7,25,09,35,0) )
pevent1ii20 = (tgf20 .> DateTime(2022,7,25,07,35,0)) .& (tgf20.< DateTime(2022,7,25,09,35,0) )
...
grt = DateTime(2022,7,25,09,35,0):Minute(1):DateTime(2022,7,25,12,30,0) |> collect
