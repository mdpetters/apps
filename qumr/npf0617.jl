...
# df = CSV.read("../level3dataall/hou120ncsuhtdmainvertedM1.b1.20220615.csv", DataFrame; header=false)
...
# event 1 k----
event1ii50 = (tgf50 .>= DateTime(2022,6,17,09,00,0)) .& (tgf50.<= DateTime(2022,6,17,10,57,0) )
event1ii40 = (tgf40 .>= DateTime(2022,6,17,09,00,0)) .& (tgf40.<= DateTime(2022,6,17,11,57,0) )
event1ii30 = (tgf30 .>= DateTime(2022,6,17,09,00,0)) .& (tgf30.<= DateTime(2022,6,17,11,57,0) )
event1ii20 = (tgf20 .>= DateTime(2022,6,17,09,00,0)) .& (tgf20.<= DateTime(2022,6,17,11,57,0) )
...
# event 1 prior k----
pevent1ii50 = (tgf50 .> DateTime(2022,6,17,07,00,0)) .& (tgf50.< DateTime(2022,6,17,09,00,0) )
pevent1ii40 = (tgf40 .> DateTime(2022,6,17,07,00,0)) .& (tgf40.< DateTime(2022,6,17,09,00,0) )
pevent1ii30 = (tgf30 .> DateTime(2022,6,17,07,00,0)) .& (tgf30.< DateTime(2022,6,17,09,00,0) )
pevent1ii20 = (tgf20 .> DateTime(2022,6,17,07,00,0)) .& (tgf20.< DateTime(2022,6,17,09,00,0) )
...
grt = DateTime(2022,6,17,09,00,0):Minute(1):DateTime(2022,6,17,11,57,0) |> collect
